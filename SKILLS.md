...
| 🟩 Imperative programming      | 🟩 new                | 🟩 Mutable state     | 🟩 Iterator              |
| 🟩 Structured programming      | 🟩 Static method      | 🟩 Immutable state   | 🟩 Observer               |
| 🟩 Non-structured programming  | 🟩 Method             | 🟩 Enum              | 🟩 Builder                |
| 🟩 Functional programming      | 🟩 Async method       | 🟩 Linked list       | 🟩 Prototype              |
| 🟩 Prototype-based programming | 🟩 Getters, Setters   | 🟩 Doubly list       | 🟩 Memento                |
| 🟩 Object-oriented programming | 🟩 Public fields      | 🟩 Unrolled list     | 🟩 Factory                |
| ⬜ Object-based programming    | 🟩 Private fields     | 🟩 Circular list     | 🟩 Adapter               |
| 🟩 Generic programming         | 🟩 Field declarations | 🟩 Trees             | 🟩 Flyweight             |
| 🟩 Concurrent computing        | 🟩 Inheritance        | 🟩 Graphs            | 🟩 Composite             |
| 🟩 Asyncronous programming     | 🟩 Parent class       | 🟩 Functor           | 🟩 Decorator             |
| 🟩 Parallel programming        | 🟩 Polymorphism       | 🟩 Functional object | 🟩 Proxy                 |
| 🟩 Reactive programming        | 🟩 Abstract class     | 🟩 Monad             | 🟩 Facade                |
| ⬜ FRP (Functional-reactive)   | 🟩 Interface          | 🟩 Generator         | 🟩 Command               |
| 🟩 Automata-based programming  | 🟩 Encapsulation      | 🟩 Iterator          | 🟩 Mediator              |
| 🟩 Domain-specific languages   | ⬜ Hidden class       | 🟩 Async Iterator    | 🟩 Strategy              |
| 🟩 Multi-paradigm programming  | ⬜ Object form        |                      | 🟩 Template              |
...
| Theory               | Specifics                    | Frameworks/Libraries|
|----------------------|------------------------------|---------------------|
| 🟩 JVM               |  🟩 Generics                  | 🟩 Spring       
| 🟩 Threads           |  🟩 Streams                   |  🟦 Guava
| 🟩 Memory managment  |  🟩 Networking                |  🟦 Log4j2 |
|                      |                              |  🟦 Hibernate
|                      |                              | 🟩 JUnit
...
| Theory               | Specifics                    |
|----------------------|------------------------------|
| 🟩 DI (and SOLID overall) |  🟩 Streams (very different to Java's) 
| 🟩 MVC                    |  🟩 State management 
| 🟩 BloC                   |  🟩 Networking
  🟩 Framework architecture fundamentals | 🟩 SQLite
| 🟩 Redux                               | 🟩 Shared Preferences
| 🟩 MVVM                              
| 🟩 KISS
